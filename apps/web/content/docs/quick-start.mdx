...
<Steps>
  <Step>The SDK opens a WebSocket to Cloudflare's edge network, nearest to the user.</Step>
  <Step>A Durable Object aggregates all connections for your app key + tag combination.</Step>
  <Step>
